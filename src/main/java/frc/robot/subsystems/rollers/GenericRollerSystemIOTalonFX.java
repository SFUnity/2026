...
public class GenericRollerSystemIOTalonFX implements GenericRollerSystemIO {
  private final TalonFX talon;
  private final VoltageOut voltageOut = new VoltageOut(0).withEnableFOC(true).withUpdateFreqHz(0);
  private final NeutralOut neutralOut = new NeutralOut();

  public GenericRollerSystemIOTalonFX(int id, int currentLimitAmps, boolean invert) {
